        ...
        <div class="email-content">
            ...
            <div class="email-body">
                ...
                <div class="email-text">
                    ...
                    <p>Kami ingin memberitahukan Anda bahwa akun Anda telah dihapus dari sistem kami.</p>
                    <p>Jika Anda merasa ini adalah kesalahan atau memiliki pertanyaan lebih lanjut, jangan ragu untuk menghubungi kami.</p>
                </div>
                <div class="confirm-btn">
                    <a href="mailto:{{ env('MAIL_FROM_ADDRESS') }}">Hubungi Kami</a>
                </div>
            </div>
